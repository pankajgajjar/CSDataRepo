 ...
 */
    ...
    {
        $iTotalCount = $this->dataOperation->getColumn('select count(*) 
        												from csdataproducts 
 ...
 */
    ...
    {
        $map = $this->dataOperation->getAll('select distinct attribute_id,attribute_name
        									 from csdataattribute');
        return $map;
    }
    ...
    {
        $iTotalCount = $this->dataOperation->getColumn('select attribute_name 
        												from attributemap
