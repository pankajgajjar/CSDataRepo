...
require_once '../CSLive/plugins/CSDataImport/Persistence/CSDataOperations.php';
...
class CSStoreDataUsingRedBeanPHP implements ICSStoreData
{
   ...
   */
    ...
    {
        return $this->dataOperation->storeAll($oBeans);
    }
   ...
   */
    ...
    {
        return $this->dataOperation->store($oBean);
    }
  ...
  */
    ...
    {
        $oPtable = $this->dataOperation->dispenseBeanObject('csdataproducts');
        return $oPtable;
    }
  ...
  */
    ...
    {
        $oCtable = $this->dataOperation->dispenseBeanObject('csdataattribute', $iNumOfObject);
        return $oCtable;
    }
 ...
 */
    ...
    {
        $oCtable =$this->dataOperation->dispenseBeanObject('cstransaction');
        return $oCtable;
    }
 ...
 */
    ...
    {
        $this->dataOperation->deleteTable('csdataproducts');
    }
 ...
 */
    ...
    {
        $this->dataOperation->deleteTable('csdataattribute');
    }
 ...
 */
    ...
    {
        $iTotalCount = $this->dataOperation->getColumn('select count(*) from csdataproducts where tranactionid = ' . $id);
 ...
 */
    ...
    {
        $iTotalCount = $this->dataOperation->getColumn('select MAX(id) from cstransaction');
        if ($iTotalCount == null) {
            $iTotalCount[0] = 0;
        }
    ...
    {
        $map = $this->dataOperation->getAll('select distinct attribute_id,attribute_name from csdataattribute');
        return $map;
    }
    ...
    {
        $iTotalCount = $this->dataOperation->getColumn('select attribute_name from attributemap where attribute_id = ' . $id);
        return $iTotalCount[0];
    }
    
    public function getArrayMapForAttributes()
    {
    	$iTotalMap = $this->dataOperation->getAll('select distinct conf.PdmarticleconfigurationID attribute_id, conf.Label attribute_name
    ...
    public function storeMappingTransactionTable($attributeArray)
    {
    	...
    	{
    		$this->dataOperation->exec('Insert into cs_transaction_map values('."'".$value."'".","."'".$key."')");
    	}	
