<?php
require_once 'Interator/ArticleUpdate/CSUpdateArticle.php';
require_once 'Interator/ImportLanguage/CSImportLanguage.php';
require_once 'Interator/ArticleImport/CSArticleImport.php';
...
{
	$updateArticle->updateProductLabels($updatedArticleLabels);
}
